...
FIXED_RESOURCE_FIELDS_DEFAULT: Final = ["cpu_limit", "memory_limit"]
...
PROGRESSIVE_YIELD_INTERVAL_DEFAULT: Final = 2
PROGRESSIVE_PARALLELISM_DEFAULT: Final = 2

__all__ = [
    "AI_FIX_BULK_PARALLELISM_DEFAULT",
    "FIXED_RESOURCE_FIELDS_DEFAULT",
